            ...
            <div class="col-sm-8" style="padding-right: 7.5px !important;">
              ...
              <div style="margin-bottom: 10px" class="input-group">
                    ...
                    <select class="form-control" onChange="Pilih1(this);">
                      ...
                      <option value="PayPal">PayPaI</option>
                      <option value="PayPal Service">PaypaI Service</option>
                      <option value="PayPal Support">PaypaI Support</option>
                    ...
                    <select class="form-control kanan" onChange="Pilih2(this);">
					  ...
					  <option value="service@ipaypal.com">service@ipaypal.com</option>
                      <option value="service@intl.ipaypal.com">service@intl.ipaypal.com</option>
                      <option value="service@ipaypal.co.uk">service@ipaypal.co.uk</option>
                      <option value="paypaI@e.ipaypal.co.uk">paypaI@e.ipaypal.co.uk</option>
              ...
              <div style="margin-bottom: 10px" class="input-group">
                    ...
                    <select class="form-control kanan" onChange="Pilih3(this);">
					  ...
					  <option value="PayPal Service">PayPal Service</option>
...
<div id="footer">
      <div class="container" align="center">
        <p class="muted credit" style="color: white;">Copyright &copy; 2014 - '.gmdate('Y').' <a href="http://google.com">Google</a>. By <a href="http://xvideos.com">nitr0</a>.</p>
      </div>
</div>';$mail->SmtpClose();
